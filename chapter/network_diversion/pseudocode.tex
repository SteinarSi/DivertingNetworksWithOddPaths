\section{Pseudocode}
Here comes the pseudocode for our \textsc{Network Diversion} algorithm. For a run-through of the algorithm on an example graph, see \Cref{subsection:network-diversion-example}.
% /**
%     In:
