...
\todo{Fra Pål: there is no obvious way to solve Shortest Detour Path. Footnote: The classical solution to this is of course finding vertex disjoint paths using a max flow based algorithm (REFORMULATE)}
