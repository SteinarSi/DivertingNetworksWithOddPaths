...
\todo{bench again with the newer graphs, and write about how fast it is}
...
With that said, we are very happy with these results. \todo{update this sentence with new data} Being able to solve graphs of millions of nodes in seconds is exactly the performance we were hoping for.
