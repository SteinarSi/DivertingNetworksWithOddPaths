\section{Psuedocode}
Here we give a detailed psuedocode of the algorithm, along with explanations of some of the finer details should the interested reader consider implementing the algorithm on their own. For all of the code in one piece without comments or alternatives, see Appendix \ref{appendix:full-psuedocode}. And of course, to see the code implemented in Rust, see the GitHub repository \todo[inline]{link github here}.
